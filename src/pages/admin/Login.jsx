...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!email || !password) return toast.error('أدخل البريد الإلكتروني وكلمة المرور');
    setLoading(true);
    try {
  ...
  return (
    <div className="admin-login-page">
      ...
      <div className="login-card">
        ...
        <p className="login-subtitle">تسجيل الدخول للإدارة</p>
          ...
          <div className="form-group">
            ...
            <div className="input-wrap">
              ...
              <input
                ...
                placeholder="admin@samagroup.com"
                autoComplete="email"
                required
              />
            </div>
